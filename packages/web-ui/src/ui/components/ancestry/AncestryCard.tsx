      ...
      <div className="relative z-10">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
             ...
             <span className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em]">Traits</span>
             <div className="h-px bg-slate-700 flex-1" />
          </div>
          
          <ul className="grid grid-cols-1 gap-2">
            {[...hero.ancestry.signatureTraits, ...hero.ancestry.purchasedTraits].map((t) => (
              <li key={t.id} className="flex items-center gap-2 text-sm font-medium text-slate-300 group-hover:text-slate-200 transition-colors">
